    ...
    <section className="complete-checkout mx-auto pt-lg-145 pb-lg-145 pt-100 pb-80">
      <div className="container-fluid">
        <div className="text-center">
          <svg className="img-fluid" width="343" height="300" viewBox="0 0 343 300" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0)">
              <path d="M263.96 271.587C264.986 271.07 265.5 270.554 266.525 270.037" stroke="#FF78B7" stroke-width="0.6123" stroke-linecap="round" stroke-linejoin="round" />
              <path
              ...
              />
              <path d="M163.407 187.897C164.433 187.897 165.46 187.897 166.486 187.897" stroke="#FF78B7" stroke-width="0.6123" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M30.5337 294.317H334.245" stroke="#B1B9CC" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M2.8302 294.317H15.1428" stroke="#B1B9CC" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
              ...
              <path
                ...
                stroke-linejoin="round"
              />
              <path opacity="0.7" d="M280.89 275.72L150.068 300C148.016 298.967 146.477 296.383 146.477 293.802V215.277C146.477 211.144 149.555 208.044 153.659 208.044H273.707L280.89 275.72Z" fill="url(#paint7_linear)" />
              <path
            ...
            <defs>
              <linearGradient id="paint0_linear" x1="208.801" y1="72.5824" x2="254.26" y2="72.5824" gradientUnits="userSpaceOnUse">
                <stop offset="0.00289017" stop-color="#E6ECF5" />
                <stop offset="1" stop-color="#CED7E2" />
              </linearGradient>
              <linearGradient id="paint1_linear" x1="143.285" y1="14.5673" x2="143.285" y2="143.347" gradientUnits="userSpaceOnUse">
                <stop stop-color="#FF66A9" />
                <stop offset="1" stop-color="#F53689" />
              </linearGradient>
              <linearGradient id="paint2_linear" x1="163.166" y1="127.787" x2="156.337" y2="4.80769" gradientUnits="userSpaceOnUse">
                <stop stop-color="#FF66A9" />
                <stop offset="1" stop-color="#F53689" />
              </linearGradient>
              <linearGradient id="paint3_linear" x1="6.76077" y1="181.739" x2="18.528" y2="181.739" gradientUnits="userSpaceOnUse">
                <stop stop-color="#FF66A9" />
                <stop offset="1" stop-color="#F53689" />
              </linearGradient>
              <linearGradient id="paint4_linear" x1="286.418" y1="33.7799" x2="297.858" y2="33.7799" gradientUnits="userSpaceOnUse">
                <stop stop-color="#83A6FF" />
                <stop offset="1" stop-color="#5A78FF" />
              </linearGradient>
              <linearGradient id="paint5_linear" x1="334.206" y1="85.84" x2="342.314" y2="85.84" gradientUnits="userSpaceOnUse">
                <stop stop-color="#FF66A9" />
                <stop offset="1" stop-color="#F53689" />
              </linearGradient>
              <linearGradient id="paint6_linear" x1="61.3001" y1="56.4076" x2="61.3001" y2="288.195" gradientUnits="userSpaceOnUse">
                <stop offset="0.00289017" stop-color="#E6ECF5" />
                <stop offset="1" stop-color="#CED7E2" />
              </linearGradient>
              ...
              <linearGradient id="paint8_linear" x1="235.098" y1="243.554" x2="317.994" y2="300.73" gradientUnits="userSpaceOnUse">
                <stop stop-color="#83A6FF" />
                <stop offset="1" stop-color="#5A78FF" />
              </linearGradient>
              <clipPath id="clip0">
        ...
        <div className="button-group d-flex flex-column mx-auto">
          <a className="btn btn-dashboard fw-medium text-lg text-white rounded-pill mb-16" href="../member/overview.html" role="button">
            My Dashboard
          </a>
