...
const SignUpPhoto: NextPage = (props: Props) => {
  return (
        ...
        <form action="">
          <div className="form-input d-md-block d-flex flex-column">
            ...
            <div className="button-group d-flex flex-column mx-auto">
              <a className="btn btn-create fw-medium text-lg text-white rounded-pill mb-16" href="./sign-up-photo-success.html" role="button">
                Create My Account
              </a>
